...
class myClassifier:
    ...
    def hyper_optimization(self):
        ...
        tmp_trial = Trials()
        best_sln = fmin(self.opt_objective, space=params_space, algo=tpe.suggest, max_evals=20, trials=tmp_trial)  # find the best hyper parameters
        ...
        with open('bst_param_set.pkl', 'wb') as fo:
